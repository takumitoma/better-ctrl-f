...
const diacriticsMap = new Map<string, string>();

// https://stackoverflow.com/a/5912746
...
defaultDiacriticsRemovalMap.forEach(({ base, letters }) => {
  for (let i = 0; i < letters.length; i++) {
    diacriticsMap.set(letters[i], base);
  }
});
